...
% =====================================================================
% --- Bibliography inlined (no BibTeX / no .bib needed; compiles with pdfLaTeX alone) ---
...
\bibitem[Mordecai et~al.(2017)Mordecai, Cohen, Evans, Gudapati, Johnson, Lippi,
  Miazgowicz, Murdock, Rohr, Ryan, Savage, Shocket, Stewart~Ibarra, Thomas, and
  Weikel]{Mordecai2017}
Erin~A. Mordecai, Jeremy~M. Cohen, Michelle~V. Evans, Prithvi Gudapati, Leah~R.
  Johnson, Catherine~A. Lippi, Kerri Miazgowicz, Courtney~C. Murdock, Jason~R.
  Rohr, Sadie~J. Ryan, Van~M. Savage, Marta~S. Shocket, Anna~M. Stewart~Ibarra,
  Matthew~B. Thomas, and Daniel~P. Weikel.
\newblock Detecting the impact of temperature on transmission of {Zika},
  dengue, and chikungunya using mechanistic models.
\newblock \emph{PLOS Neglected Tropical Diseases}, 11\penalty0 (4):\penalty0
  e0005568, 2017.
\newblock \doi{10.1371/journal.pntd.0005568}.

\bibitem[Huber et~al.(2018)Huber, Childs, Caldwell, and Mordecai]{Huber2018}
John~H. Huber, Marissa~L. Childs, Jamie~M. Caldwell, and Erin~A. Mordecai.
\newblock Seasonal temperature variation influences climate suitability for
  dengue, chikungunya, and {Zika} transmission.
\newblock \emph{PLOS Neglected Tropical Diseases}, 12\penalty0 (5):\penalty0
  e0006451, 2018.
\newblock \doi{10.1371/journal.pntd.0006451}.

\bibitem[Johansson et~al.(2019)Johansson, Apfeldorf, Dobson, Devita, Buczak,
  Baugher, Moniz, Bagley, Babin, Guven, Yamana, Shaman, et~al.]{Johansson2019}
Michael~A. Johansson, Karyn~M. Apfeldorf, Scott Dobson, Jason Devita, Anna~L.
  Buczak, Benjamin Baugher, Linda~J. Moniz, Thomas Bagley, Steven~M. Babin,
  Erhan Guven, Teresa~K. Yamana, Jeffrey Shaman, et~al.
...
\newblock \emph{Proceedings of the National Academy of Sciences}, 116\penalty0
  (48):\penalty0 24268--24274, 2019.
\newblock \doi{10.1073/pnas.1909865116}.

\bibitem[Baharom et~al.(2022)Baharom, Ahmad, Hod, and Abdul~Manaf]{Baharom2022}
M.~Baharom, N.~Ahmad, R.~Hod, and M.~R. Abdul~Manaf.
\newblock Dengue early warning system as outbreak prediction tool: a systematic
  review.
\newblock \emph{Risk Management and Healthcare Policy}, 15:\penalty0 871--886,
  2022.
\newblock \doi{10.2147/RMHP.S361106}.

\bibitem[Hussain-Alkhateeb et~al.(2021)Hussain-Alkhateeb, Rivera~Ramirez,
  Kroeger, Gozzer, and Runge-Ranzinger]{HussainAlkhateeb2021}
Laith Hussain-Alkhateeb, Tatiana Rivera~Ramirez, Axel Kroeger, Ernesto Gozzer,
  and Silvia Runge-Ranzinger.
\newblock Early warning systems ({EWSs}) for chikungunya, dengue, malaria,
  yellow fever, and {Zika} outbreaks: what is the evidence? a scoping review.
\newblock \emph{PLOS Neglected Tropical Diseases}, 15\penalty0 (9):\penalty0
  e0009686, 2021.
\newblock \doi{10.1371/journal.pntd.0009686}.

\bibitem[Lowe et~al.(2021)Lowe, Lee, O'Reilly, Brady, Bastos, Carrasco-Escobar,
  de~Castro~Cat{\~a}o, Col{\'o}n-Gonz{\'a}lez, Barcellos, Carvalho, Blangiardo,
  and Gasparrini]{Lowe2021}
Rachel Lowe, Sophie~A. Lee, Kathleen~M. O'Reilly, Oliver~J. Brady, Leonardo
  Bastos, Gabriel Carrasco-Escobar, Rafael de~Castro~Cat{\~a}o, Felipe~J.
  Col{\'o}n-Gonz{\'a}lez, Christovam Barcellos, Marilia~S. Carvalho, Marta
  Blangiardo, and Antonio Gasparrini.
\newblock Combined effects of hydrometeorological hazards and urbanisation on
  dengue risk in {Brazil}: a spatiotemporal modelling study.
\newblock \emph{The Lancet Planetary Health}, 5\penalty0 (4):\penalty0
  e209--e219, 2021.
\newblock \doi{10.1016/S2542-5196(20)30292-8}.
...
\bibitem[Van~Calster et~al.(2023)Van~Calster, Steyerberg, Wynants, and van
  Smeden]{VanCalster2023}
Ben Van~Calster, Ewout~W. Steyerberg, Laure Wynants, and Maarten van Smeden.
\newblock There is no such thing as a validated prediction model.
\newblock \emph{BMC Medicine}, 21:\penalty0 70, 2023.
\newblock \doi{10.1186/s12916-023-02779-w}.

\bibitem[Steyerberg and Vergouwe(2014)]{SteyerbergVergouwe2014}
...
\newblock \emph{European Heart Journal}, 35\penalty0 (29):\penalty0 1925--1931,
  2014.
\newblock \doi{10.1093/eurheartj/ehu207}.

\bibitem[Vickers and Elkin(2006)]{Vickers2006}
Andrew~J. Vickers and Elena~B. Elkin.
\newblock Decision curve analysis: a novel method for evaluating prediction
  models.
\newblock \emph{Medical Decision Making}, 26\penalty0 (6):\penalty0 565--574,
  2006.
\newblock \doi{10.1177/0272989X06295361}.

\bibitem[Vickers et~al.(2016)Vickers, Van~Calster, and Steyerberg]{Vickers2016}
Andrew~J. Vickers, Ben Van~Calster, and Ewout~W. Steyerberg.
\newblock Net benefit approaches to the evaluation of prediction models,
  molecular markers, and diagnostic tests.
\newblock \emph{BMJ}, 352:\penalty0 i6, 2016.
\newblock \doi{10.1136/bmj.i6}.

\bibitem[Vickers et~al.(2019)Vickers, van Calster, and Steyerberg]{Vickers2019}
Andrew~J. Vickers, Ben van Calster, and Ewout~W. Steyerberg.
\newblock A simple, step-by-step guide to interpreting decision curve analysis.
\newblock \emph{Diagnostic and Prognostic Research}, 3:\penalty0 18, 2019.
\newblock \doi{10.1186/s41512-019-0064-7}.

\bibitem[Murphy(1985)]{Murphy1985}
Allan~H. Murphy.
\newblock Decision making and the value of forecasts in a generalized model of
  the cost-loss ratio situation.
\newblock \emph{Monthly Weather Review}, 113\penalty0 (3):\penalty0 362--369,
  1985.
\newblock \doi{10.1175/1520-0493(1985)113<0362:DMATVO>2.0.CO;2}.

\bibitem[Tozan et~al.(2023)Tozan, Sewe, Kim, and Rockl{\"o}v]{Tozan2023}
Yesim Tozan, Maquins~O. Sewe, Sooyoung Kim, and Joacim Rockl{\"o}v.
\newblock A methodological framework for economic evaluation of operational
  response to vector-borne diseases based on early warning systems.
\newblock \emph{American Journal of Tropical Medicine and Hygiene},
  108\penalty0 (3):\penalty0 627--633, 2023.
\newblock \doi{10.4269/ajtmh.22-0471}.

\bibitem[Hussain-Alkhateeb et~al.(2024)]{EWARScsd}
Laith Hussain-Alkhateeb et~al.
\newblock Enabling countries to manage outbreaks: statistical, operational, and
  contextual analysis of the early warning and response system ({EWARS-csd})
  for dengue outbreaks.
\newblock \emph{Frontiers in Public Health}, 12:\penalty0 1323618, 2024.
\newblock \doi{10.3389/fpubh.2024.1323618}.

\bibitem[von Elm et~al.(2007)von Elm, Altman, Egger, Pocock, G{\o}tzsche, and
  Vandenbroucke]{vonElm2007}
Erik von Elm, Douglas~G. Altman, Matthias Egger, Stuart~J. Pocock, Peter~C.
  G{\o}tzsche, and Jan~P. Vandenbroucke.
\newblock The {Strengthening} the {Reporting} of {Observational} {Studies} in
  {Epidemiology} ({STROBE}) statement: guidelines for reporting observational
  studies.
\newblock \emph{The Lancet}, 370\penalty0 (9596):\penalty0 1453--1457, 2007.
\newblock \doi{10.1016/S0140-6736(07)61602-X}.

\bibitem[Collins et~al.(2024)Collins, Dhiman, Navarro, Ma, Hooft, Reitsma,
  Logullo, Beam, Peng, Van~Calster, et~al.]{Collins2024TRIPODAI}
Gary~S. Collins, Paula Dhiman, Clara~L. Navarro, Jie Ma, Lotty Hooft,
  Johannes~B. Reitsma, Patricia Logullo, Andrew~L. Beam, Liangying Peng, Ben
  Van~Calster, et~al.
...
\bibitem[Wolff et~al.(2019)Wolff, Moons, Riley, Whiting, Westwood, Collins,
  Reitsma, Kleijnen, and Mallett]{Wolff2019}
Robert~F. Wolff, Karel G.~M. Moons, Richard~D. Riley, Penny~F. Whiting, Marie
  Westwood, Gary~S. Collins, Johannes~B. Reitsma, Jos Kleijnen, and Susan
  Mallett.
\newblock {PROBAST}: a tool to assess the risk of bias and applicability of
  prediction model studies.
\newblock \emph{Annals of Internal Medicine}, 170\penalty0 (1):\penalty0
  51--58, 2019.
\newblock \doi{10.7326/M18-1376}.

\bibitem[Moons et~al.(2019)Moons, Wolff, Riley, Whiting, Westwood, Collins,
  Reitsma, Kleijnen, and Mallett]{Moons2019}
Karel G.~M. Moons, Robert~F. Wolff, Richard~D. Riley, Penny~F. Whiting, Marie
  Westwood, Gary~S. Collins, Johannes~B. Reitsma, Jos Kleijnen, and Susan
  Mallett.
\newblock {PROBAST}: a tool to assess risk of bias and applicability of
  prediction model studies: explanation and elaboration.
\newblock \emph{Annals of Internal Medicine}, 170\penalty0 (1):\penalty0
  W1--W33, 2019.
\newblock \doi{10.7326/M18-1377}.

\bibitem[{Humanitarian Data Exchange / OCHA / Survey Department of Sri
  Lanka}(2022)]{HDXCODABSriLanka}
{Humanitarian Data Exchange / OCHA / Survey Department of Sri Lanka}.
\newblock Sri lanka administrative boundaries ({COD-AB}).
\newblock Humanitarian Data Exchange, 2022.

\bibitem[{Epidemiology Unit, Ministry of Health, Sri
  Lanka}(2018--2025)]{SriLankaWER}
{Epidemiology Unit, Ministry of Health, Sri Lanka}.
\newblock Weekly epidemiological report: dengue current-week case tables.
\newblock Public weekly surveillance reports, 2018--2025.

\bibitem[Clarke et~al.(2024)Clarke, Lim, Gupte, Pigott, van Panhuis, and
  Brady]{Clarke2024OpenDengue}
Joseph Clarke, Ahyoung Lim, Pratik Gupte, David~M. Pigott, Wilbert~G. van
  Panhuis, and Oliver~J. Brady.
\newblock A global dataset of publicly available dengue case count data, 2024.

\bibitem[{OpenDengue}(2024)]{OpenDengue2024}
{OpenDengue}.
\newblock {OpenDengue} database (temporal extract, version 1.3).
\newblock figshare, 2024.

\bibitem[Tatem(2017)]{Tatem2017}
Andrew~J. Tatem.
\newblock {WorldPop}, open data for spatial demography.
\newblock \emph{Scientific Data}, 4:\penalty0 170004, 2017.
\newblock \doi{10.1038/sdata.2017.4}.

\bibitem[{WorldPop}(2025)]{WorldPop2025}
{WorldPop}.
\newblock Global 2015--2030 population data, {R2025A}, 100m.
\newblock WorldPop, University of Southampton, 2025.

\bibitem[{Department of Census and Statistics, Sri
  Lanka}(2025)]{SriLankaCensus2025}
{Department of Census and Statistics, Sri Lanka}.
\newblock Census of population and housing 2024: basic population information
  by districts and {DS} divisions.
\newblock Government statistical release (district totals released 30 Oct
  2025), 2025.

\bibitem[Mu{\~n}oz-Sabater et~al.(2021)Mu{\~n}oz-Sabater, Dutra,
  Agust{\'i}-Panareda, Albergel, Arduini, Balsamo, Boussetta, Choulga,
  Harrigan, Hersbach, et~al.]{MunozSabater2021}
Joaqu{\'i}n Mu{\~n}oz-Sabater, Emanuel Dutra, Anna Agust{\'i}-Panareda,
  Cl{\'e}ment Albergel, Gabriele Arduini, Gianpaolo Balsamo, Souhail Boussetta,
  Margarita Choulga, Shaun Harrigan, Hans Hersbach, et~al.
\newblock {ERA5-Land}: a state-of-the-art global reanalysis dataset for land
  applications.
\newblock \emph{Earth System Science Data}, 13:\penalty0 4349--4383, 2021.
\newblock \doi{10.5194/essd-13-4349-2021}.

\bibitem[{Copernicus Climate Change Service}(2019)]{ERA5LandCDS}
{Copernicus Climate Change Service}.
\newblock {ERA5-Land} hourly data from 1950 to present.
\newblock Copernicus Climate Data Store (CDS), 2019.

\bibitem[Funk et~al.(2015)Funk, Peterson, Landsfeld, Pedreros, Verdin, Shukla,
  Husak, Rowland, Harrison, Hoell, and Michaelsen]{Funk2015}
Chris Funk, Pete Peterson, Martin Landsfeld, Diego Pedreros, James Verdin,
  Shraddhanand Shukla, Gregory Husak, James Rowland, Laura Harrison, Andrew
  Hoell, and Joel Michaelsen.
\newblock The climate hazards infrared precipitation with stations---a new
  environmental record for monitoring extremes.
\newblock \emph{Scientific Data}, 2:\penalty0 150066, 2015.
\newblock \doi{10.1038/sdata.2015.66}.

\bibitem[{Climate Hazards Center, UC Santa Barbara}(2015)]{CHIRPS}
{Climate Hazards Center, UC Santa Barbara}.
\newblock {CHIRPS}: Climate hazards group {InfraRed} precipitation with station
  data.
\newblock University of California, Santa Barbara, 2015.

\bibitem[Gasparrini et~al.(2010)Gasparrini, Armstrong, and
  Kenward]{Gasparrini2010}
Antonio Gasparrini, Ben Armstrong, and Michael~G. Kenward.
\newblock Distributed lag non-linear models.
\newblock \emph{Statistics in Medicine}, 29\penalty0 (21):\penalty0 2224--2234,
  2010.
\newblock \doi{10.1002/sim.3940}.

\bibitem[Gasparrini(2011)]{Gasparrini2011}
Antonio Gasparrini.
\newblock Distributed lag linear and non-linear models in {R}: the package
  {dlnm}.
\newblock \emph{Journal of Statistical Software}, 43\penalty0 (8):\penalty0
  1--20, 2011.
\newblock \doi{10.18637/jss.v043.i08}.
...
\bibitem[Saito and Rehmsmeier(2015)]{SaitoRehmsmeier2015}
...
\bibitem[Cameron et~al.(2008)Cameron, Gelbach, and
  Miller]{CameronGelbachMiller2008}
...
\newblock \emph{Review of Economics and Statistics}, 90\penalty0 (3):\penalty0
  414--427, 2008.
\newblock \doi{10.1162/rest.90.3.414}.
