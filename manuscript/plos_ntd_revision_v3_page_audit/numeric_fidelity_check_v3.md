# Numeric fidelity check — v3 (transcription only; no recomputation)

Every displayed number is transcribed from a frozen committed report (verified 200/0 in the prior fidelity audit; re-mapped in `claim_source_crosswalk_v3.md`). No model, metric, bootstrap, or sensitivity was run for v3.
