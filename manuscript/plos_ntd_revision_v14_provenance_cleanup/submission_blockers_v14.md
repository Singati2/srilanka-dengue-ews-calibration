# Submission blockers — v14 (carried forward from v12; not invented)

v14 is an integrity cleanup; it resolved no administrative blocker and invented no metadata. The title page remains "Internal review copy—not for submission."
...
## v14 integrity-cleanup notes (not blockers)
...
- New evidence files: `colombia_2022_week_eligibility_v14.md`, `targeted_value_seed_resolution_v14.md`.
