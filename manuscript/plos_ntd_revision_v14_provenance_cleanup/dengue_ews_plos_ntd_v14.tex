...
% =====================================================================
% PLOS NTD revision v14 (provenance cleanup).
% PROVENANCE: Derived directly from the preserved revision v13 (integrity-cleanup)
% source. v14 is a documentation/provenance cleanup only: it removes internal editorial
% language and filenames from the OpenDengue bibliography entry while keeping the
% locally-analyzed-file / verified-V1.3 / generic-Figshare-DOI / unresolved-record-version
% distinction in Methods, Data Availability, S10 and the submission blockers; independently
% traces and documents the all-test Sri Lanka hybrid bootstrap seed (20260612, verified
% from the hybrid runner script and metadata, not from S6 and not inferred from the
% targeted-value run); and rewords the Sri Lanka Discussion sentence into estimate-only
% form (no comparative or interval-zero verdict).
% No statistical/predictive analysis was rerun; numbers are reused verbatim from frozen
% committed reports and the audited v2 outputs. Unresolved administrative metadata are
% tracked in submission_blockers_v14.md (not in the manuscript body). Not for submission.
% =====================================================================
