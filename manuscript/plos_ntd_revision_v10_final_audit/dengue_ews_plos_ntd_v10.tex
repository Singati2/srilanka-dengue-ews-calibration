...
\noindent All items below exist as standalone files transcribed from frozen committed reports (no recomputation). Checklists S1--S3 and the inventory S10 remain drafts pending author finalization; S4--S9 are complete and awaiting author approval. No item is submission-final until the declarations and checklists are completed (see the Supporting-Information status record and \texttt{submission\_blockers\_v10.md}).\\[0.4em]
