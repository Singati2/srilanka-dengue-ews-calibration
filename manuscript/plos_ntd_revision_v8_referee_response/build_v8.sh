...
#   1) dengue_ews_v8_internal_author_review.pdf   (line numbers OFF; author standing preference)
#   2) dengue_ews_v8_line_numbered_review.pdf      (continuous line numbers ON)
...
set -euo pipefail
cd "$(dirname "$0")"
TEX="dengue_ews_plos_ntd_v8.tex"
...
build "dengue_ews_v8_internal_author_review" ""
# 2) line-numbered review
build "dengue_ews_v8_line_numbered_review" "\\def\\linenumberedcopy{}"
