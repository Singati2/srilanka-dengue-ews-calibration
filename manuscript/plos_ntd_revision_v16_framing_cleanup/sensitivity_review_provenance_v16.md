# AI-review provenance (internal documentation — v16)

This note records, for internal documentation only, how (a) the two author-authorized secondary sensitivity analyses, (b) the v13 integrity edits, and (c) the v16 limitations revision roadmap were reviewed. It is **not** part of the manuscript, Supporting Information, cover letter, or declarations.

## Provenance statement (authoritative wording)

For the v16 limitations revision roadmap:

> An internal AI-assisted role-based adversarial review was used to identify issues and develop a revision roadmap. It was not external human peer review or independent expert validation.
...
## Verification performed for v16
- The manuscript and Supporting Information contain no "expert-validated", "independently validated", "peer-reviewed", "external review", "field-expert", "harsh peer", or AI-agent-count statements (grep-confirmed across the v16 tex and SI).
