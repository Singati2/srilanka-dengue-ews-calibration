# Claim-source crosswalk — revision v4 (numbers → frozen sources)
...
| "No recalibration fallbacks occurred" | `rolling_recalibration_extension_report.md` §5 ("Zero fallbacks across all models and methods") |
