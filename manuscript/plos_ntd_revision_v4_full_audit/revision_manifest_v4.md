# PLOS NTD Revision v4 (full audit) — Governance Manifest

> **v4 provenance.** Reconstructed LaTeX (not the original authoring source). v4 was derived from the preserved v2/v3 working state after a complete page-by-page audit of the 21-page review PDF (`~/Downloads/Dengue (2).pdf`). v1, v2, and v3 are preserved unchanged (ledger `source_state_at_v4_start.sha256`, verified ALL-MATCH). All v4 corrections are in `manuscript/plos_ntd_revision_v4_full_audit/`. No model/metric/CI/bootstrap/sensitivity/biomodel was recomputed; every number is transcribed from frozen reports (evidence: `v4_verified_evidence_ledger.md`). `Final Version.pdf` unchanged.

> **v4 deliverables:** `dengue_ews_plos_ntd_v4.tex`, `references_v4.bib`, internal-review + grayscale PDFs, fail-fast `build_v4.sh`, `page_by_page_audit_v4.md`, `numeric_fidelity_check_v4.md` / `v4_verified_evidence_ledger.md`, `reference_integrity_report_v4.md`, `submission_blockers_v4.md`, `supporting_information_status_v4.md`, and SI drafts. Review copies in `~/Downloads/dengue_v4_full_audit/`.

---

## (earlier header retained below)
# PLOS NTD Revision v3 (page-audit) — Governance Manifest

> **Provenance (required language).** This LaTeX manuscript source was reconstructed from the June 26, 2026 manuscript PDF and user-supplied manuscript text. It is not the original authoring source. Revision v3 was derived from the preserved working state of revision v2 after a full page-by-page audit of the 17-page review PDF. Revision v2 remains unchanged (checksum ledger `v2_state_at_v3_start.sha256`); all v3 corrections are made only in `manuscript/plos_ntd_revision_v3_page_audit/`. `Final Version.pdf` remains the unchanged historical tracked manuscript.

> **v3 scope.** First-to-last-page repair of the manuscript, bibliography, structure, and visual quality. No model, metric, label, threshold, bootstrap, sensitivity, dataset, or biomodel was recomputed; all quantitative results remain frozen and transcribed from committed reports. Root cause of the 17-page empty-References PDF was a build run without `references.bib`; v3 uses a fail-fast build with a resolving bibliography. Full log in `page_by_page_corrections_v3.md`, `numeric_fidelity_check_v3.md`, `reference_resolution_report_v3.md`, `submission_blockers_v3.md`.
