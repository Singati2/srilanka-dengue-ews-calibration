...
- Documented extensions (secondary/exploratory, pointwise, multiplicity-unadjusted): threshold grid (p\*=0.20/0.30/0.40), horizons h=1/2/8/12, stricter 90th-percentile label, train-defined regimes, and the two secondary v2 sensitivities (Colombia 2022-only; Sri Lanka wild-cluster-bootstrap-t).
- No prospective public registration is claimed.

## Current Supporting-Information map (this manuscript, S1–S12)
S1 STROBE · S2/S3 TRIPOD+AI / PROBAST · S4 this chronology · S5 per-country M0–M5 specification · S6 per-analysis bootstrap protocol · S7 Sri Lanka linkage/climate-lag/2021-anomaly grid · S8 Sri Lanka targeted-value regime analysis (M5−M1) · S9 Colombia threshold/horizon/2022-only · S10 reproducibility inventory · S11 Sri Lanka wild-cluster-bootstrap-t table (+ machine-readable results) · S12 Sri Lanka wild-bootstrap method/reproducibility.
