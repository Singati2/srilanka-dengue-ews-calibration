# PROBAST / TRIPOD+AI self-assessment (prediction-model reporting & risk of bias)

> This is the **prediction-model** reporting and risk-of-bias self-assessment (S2/S3), clearly distinguished from the journal-facing **STROBE** observational checklist (S1).
...
| Data/code availability | Reported in Declarations and the Data Availability Statement |
| AI use in development | Yes | AI-assistance disclosure |

## PROBAST risk-of-bias domains (signalling summary)
