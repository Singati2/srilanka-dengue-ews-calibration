# Sensitivity-review provenance (internal documentation — v12)
...
- Grep of all v12 manuscript and SI files confirms no occurrence of "expert-validated", "independently validated", "peer-reviewed", "external review", or any AI-agent count.
