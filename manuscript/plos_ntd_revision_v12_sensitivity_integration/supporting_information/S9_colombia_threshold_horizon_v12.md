...
**Design and protocol.** Resampling unit: municipality (GID_2). B = 1000. Seed = 20260630. Interval method: percentile (2.5/97.5). Bootstrap failures: 0. Pointwise and multiplicity-unadjusted. Reference threshold p*=0.30 (planned reference threshold). Eligible prediction weeks: **48, not 52** — under the four-week-ahead horizon the four December-2022 prediction weeks (2022-12-04/11/18/25) have no observed outcome four weeks later within the assembled OpenDengue Admin-2 series, which ends at 2022-11-27; those four weeks are therefore not eligible (48 = 52 − 4). Verified against the frozen prediction file (overall maximum week_start 2022-11-27).
