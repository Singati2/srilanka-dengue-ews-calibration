...
Across four rolling-origin windows the matched climate increment $\Delta$NB(M5$-$M5$_{\text{no-climate}}$) was positive but variable: $+0.0193$ (test 2018--19), $+0.0023$ (2020), $+0.0079$ (2021), and $+0.0175$ (2022). Under leave-department-out spatial blocking the matched increment had median $+0.0052$ and was positive in 75\% of the 28 departmental test blocks that met a minimum size and both-class requirement (of 32 departments; the remainder had too few test observations or a single outcome class to evaluate). Across horizons ($h=1$--$12$) it was approximately flat ($\approx+0.008$ through $h=8$, $+0.002$ at $h=12$), consistent with a small climate-specific increment that does not grow with lead time (Figures~\ref{fig:cocal},~\ref{fig:cohoriz}).
