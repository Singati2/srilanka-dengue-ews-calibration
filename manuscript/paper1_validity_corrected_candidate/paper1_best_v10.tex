...
Standard early-warning evaluations---benchmarking climate against climatology or a null model and judging by discrimination---can overstate the value of climate data for dengue alerting. When we benchmarked against recent surveillance, judged by calibration and decision-curve net benefit, and matched for non-climate structure, climate's standalone decision value was largely absent and the apparent hybrid advantage shrank by roughly half. No climate increment survived realistic conditions: Sri Lanka was null, and the small Colombia residual (matched $+0.0078$) decayed toward zero under realistic reporting delay, had only an epidemic- and Zika-confounded pre-pandemic check, and had no clean post-pandemic test available (2023, the candidate year, was itself a record-epidemic year). It is therefore not evidence of a general, transportable climate benefit. The contribution is therefore primarily methodological: dengue alerting evaluations should benchmark against recent surveillance, match non-climate structure before attributing value to climate, and report calibration and threshold-averaged decision-curve net benefit rather than discrimination against weak comparators. Local, setting-specific evaluation remains necessary.
\end{abstract}
...
\bibitem{Sangkaew2026} Sangkaew S, et al. Early individualized risk prediction using clinical data for children during the febrile phase of dengue in outpatient settings in Vietnam and Thailand. PLOS Digit Health. 2026. [volume/DOI to be confirmed].

\bibitem{Campbell2026} Campbell AM, et al. Performance evaluation of an operational dengue forecasting system (D-MOSS) in Vietnam. PLOS Glob Public Health. 2026. [volume/DOI to be confirmed].

\bibitem{ValleDelCauca2024} 2023--24 dengue outbreak in Valle del Cauca, Colombia, caused by multiple virus serotypes and lineages. Emerg Infect Dis. 2024. [volume/DOI to be confirmed].
