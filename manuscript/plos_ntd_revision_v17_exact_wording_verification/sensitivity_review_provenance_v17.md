# AI-review provenance (internal documentation — v17)

This note records, for internal documentation only, how (a) the two author-authorized secondary sensitivity analyses, (b) the v13 integrity edits, and (c) the v17 limitations revision roadmap were reviewed. It is **not** part of the manuscript, Supporting Information, cover letter, or declarations.

## Provenance statement (authoritative wording)

For the v17 limitations revision roadmap:
...
- The manuscript and Supporting Information contain no "expert-validated", "independently validated", "peer-reviewed", "external review", "field-expert", "harsh peer", or AI-agent-count statements (grep-confirmed across the v17 tex and SI).
