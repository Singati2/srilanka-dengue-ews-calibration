...
% =====================================================================
% PLOS NTD revision v17 (exact-wording verification).
% PROVENANCE: Derived directly from the preserved revision v16 (framing-cleanup)
% source. v17 is a micro-correction and verification pass (no new numbers, no
% recomputation): it applies the author-approved exact wording to the cross-setting
% synthesis ("no formal interaction or heterogeneity analysis was performed, and
% equivalence was not assessed"; complementary evaluations, not a formal comparative
% experiment), restores the "planned primary"/"locally fitted" effect-estimate
% qualifiers, states the wild-cluster-bootstrap-t as a concordant sensitivity rather than
% independent validation, corrects the Discussion cross-setting and future-work wording,
% and corrects the elevated-activity sentence (approximately 23.5 percent test-period
% prevalence under the 90th-percentile definition; the prior informal phrasing was removed).
% Blocker statuses are reconciled from preserved evidence (OPEN / PARTIALLY VERIFIED /
% VERIFIED). Frozen numbers are unchanged.
...
% tracked in submission_blockers_v17.md (not in the manuscript body). Not for submission.
% =====================================================================
