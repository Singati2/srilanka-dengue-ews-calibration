...
% =====================================================================
% PLOS NTD revision v13 (integrity cleanup).
% PROVENANCE: Derived directly from the preserved revision v12 (sensitivity-integration)
% source. v13 applies a final integrity cleanup only: it corrects the M4/M5 estimand
% wording (M4 is the planned primary Sri Lanka full-test contrast; M5-M1 threshold/
% horizon/regime analyses are secondary/exploratory), corrects the Colombia 48-week
% eligibility explanation (prediction-origin vs target dates), removes the Colombia M4
% result from the main Discussion (retained in SI only), removes zero-crossing verdict
% language, corrects Table 6 terminology, resolves the targeted-value bootstrap seed
% (20260612, verified in the frozen runner script and diagnostics), and corrects the
% title-page blocker notice and OpenDengue provenance wording.
...
% tracked in submission_blockers_v13.md (not in the manuscript body). Not for submission.
% =====================================================================
