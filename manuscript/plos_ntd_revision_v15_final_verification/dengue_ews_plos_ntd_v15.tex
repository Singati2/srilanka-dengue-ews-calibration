...
% =====================================================================
% PLOS NTD revision v15 (final verification).
% PROVENANCE: Derived directly from the preserved revision v14 (provenance-cleanup)
% source. v15 is a verification-only cleanup: it removes the internal term "submission
% blockers" from the OpenDengue Methods prose in favour of publication-facing wording,
% neutralizes the S10 OpenDengue provenance wording (locally analyzed archive identified
% as V1.3; the cited general Figshare DOI and the analyzed archive are not linked through
% a preserved version-specific record identifier; acquisition date not preserved), and
% completes a per-page grayscale inspection. The verified seed findings are unchanged
% (all-test hybrid and targeted-value regime bootstraps: seed 20260612, B=1000, each
% traced from its own runner and metadata/diagnostics).
...
% tracked in submission_blockers_v15.md (not in the manuscript body). Not for submission.
% =====================================================================
