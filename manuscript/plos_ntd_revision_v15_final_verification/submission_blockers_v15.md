# Submission blockers — v15 (carried forward from v12; not invented)

v15 is an integrity cleanup; it resolved no administrative blocker and invented no metadata. The title page remains "Internal review copy—not for submission."
...
## v15 integrity-cleanup notes (not blockers)
...
- New evidence files: `colombia_2022_week_eligibility_v15.md`, `targeted_value_seed_resolution_v15.md`.
