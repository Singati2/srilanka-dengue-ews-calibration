...
FIG="/home/mpcrlab/srilanka-dengue-ews-calibration/manuscript/paper1_validity_corrected_candidate/Fig8.pdf"
...
rows=[("M4$-$M1 (cases+climate)", 0.0122, 0.0073, 0.0171, None, None),
      ...
      ("M5$-$matched (climate)",  0.0078, 0.0039, 0.0119, -0.0001, 0.0244),
...
ax.legend(handles=[Line2D([0],[0],color='C0',marker='o',lw=1.2,label='conditional frozen-prediction 95% CI'),
                   Line2D([0],[0],color='C1',lw=1.4,label='development-inclusive (refit) 95% CI')],
