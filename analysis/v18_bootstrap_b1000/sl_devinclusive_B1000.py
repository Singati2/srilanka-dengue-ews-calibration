...
OUT="/home/mpcrlab/srilanka-dengue-ews-calibration/analysis/v18_bootstrap_b1000/SL_devinclusive_B1000.json"
CLIMVARS=['t2m_mean_c','precip_sum_mm','rh_mean_percent']; LAGS=list(range(0,9)); SEED=20260612; CGRID=[0.1,1.0,10.0]
B=1000  # headline gate: same resampling depth as every other interval in the paper
